---
title: "4.6. Configure the Athena Query Result Location"
linkTitle: "4.6. Configure the Athena Query Result Location"
menuTitle: "4.6. Configure the Athena Query Result Location"
date: 2026-05-29
weight: 460
chapter: false
---
...
![](/images/4-Workshop/4.6-Cau-hinh-Athena-query-result-location/image-001.png)

### Configure the Query result location

In the **Athena Query editor** interface, select **Edit settings**.

![](/images/4-Workshop/4.6-Cau-hinh-Athena-query-result-location/image-002.png)

Next, select **Manage** to configure the query result storage location.

![](/images/4-Workshop/4.6-Cau-hinh-Athena-query-result-location/image-003.png)
...
![](/images/4-Workshop/4.6-Cau-hinh-Athena-query-result-location/image-004.png)

After saving successfully, Athena has been configured with the query result location in S3.

![](/images/4-Workshop/4.6-Cau-hinh-Athena-query-result-location/image-005.png)
...
![](/images/4-Workshop/4.6-Cau-hinh-Athena-query-result-location/image-006.png)
...
![](/images/4-Workshop/4.6-Cau-hinh-Athena-query-result-location/image-007.png)
...
![](/images/4-Workshop/4.6-Cau-hinh-Athena-query-result-location/image-008.png)
...
![](/images/4-Workshop/4.6-Cau-hinh-Athena-query-result-location/image-009.png)
...
![](/images/4-Workshop/4.6-Cau-hinh-Athena-query-result-location/image-010.png)
...
![](/images/4-Workshop/4.6-Cau-hinh-Athena-query-result-location/image-011.png)
...
![](/images/4-Workshop/4.6-Cau-hinh-Athena-query-result-location/image-012.png)
