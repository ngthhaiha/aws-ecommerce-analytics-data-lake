...
![Overall AWS E-commerce Analytics Data Pipeline](/images/FlowChart/4.1.Introduction.png)

This workshop simulates a complete data pipeline includes all steps from storing raw data, cataloging metadata, validating data, ETL, error handling, optimizing storage formats, creating a semantic layer, building dashboards, automating scheduled runs, and error alerting.