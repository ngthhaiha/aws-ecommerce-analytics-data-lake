---
title: "4.5. Create a Glue Crawler for Raw Data"
linkTitle: "4.5. Create a Glue Crawler for Raw Data"
menuTitle: "4.5. Create a Glue Crawler for Raw Data"
date: 2026-05-29
weight: 450
chapter: false
---
...
![](/images/FlowChart/4.5.CrawlerFlowDetail.png)
...
![](/images/4-Workshop/4.5-Tao-Glue-Crawler-cho-Raw-Data/image-001.png)
...
![](/images/4-Workshop/4.5-Tao-Glue-Crawler-cho-Raw-Data/image-002.png)

### Add a data source for the crawler

At the **Data sources** step, click **Add a data source**.

![](/images/4-Workshop/4.5-Tao-Glue-Crawler-cho-Raw-Data/image-003.png)
...
![](/images/4-Workshop/4.5-Tao-Glue-Crawler-cho-Raw-Data/image-004.png)

Select the bucket created in the previous step, then select the **raw/** folder, click **Choose** to confirm the path.

![](/images/4-Workshop/4.5-Tao-Glue-Crawler-cho-Raw-Data/image-005.png)

After selecting the S3 path, click **Add an S3 data source**.

![](/images/4-Workshop/4.5-Tao-Glue-Crawler-cho-Raw-Data/image-006.png)

Then click **Next**.

![](/images/4-Workshop/4.5-Tao-Glue-Crawler-cho-Raw-Data/image-007.png)
...
![](/images/4-Workshop/4.5-Tao-Glue-Crawler-cho-Raw-Data/image-008.png)
...
![](/images/4-Workshop/4.5-Tao-Glue-Crawler-cho-Raw-Data/image-009.png)
...
![](/images/4-Workshop/4.5-Tao-Glue-Crawler-cho-Raw-Data/image-010.png)

The crawler **crawler_ecommerce_raw** has been successfully created.

![](/images/4-Workshop/4.5-Tao-Glue-Crawler-cho-Raw-Data/image-011.png)
...
![](/images/4-Workshop/4.8.3-Chay-Glue-Crawler/image-001.png)
...
![](/images/4-Workshop/4.8.3-Chay-Glue-Crawler/image-002.png)

Click on each table to view the detailed table information.

- **raw_events:**

![](/images/4-Workshop/4.8.3-Chay-Glue-Crawler/image-003.png)

- **raw_products:**

![](/images/4-Workshop/4.8.3-Chay-Glue-Crawler/image-004.png)

- **raw_transactions:**

![](/images/4-Workshop/4.8.3-Chay-Glue-Crawler/image-005.png)
