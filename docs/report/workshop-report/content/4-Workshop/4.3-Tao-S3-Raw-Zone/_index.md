---
title: "4.3. Create S3 Raw Zone"
linkTitle: "4.3. Create S3 Raw Zone"
menuTitle: "4.3. Create S3 Raw Zone"
date: 2026-05-29
weight: 430
chapter: false
---
...
![](/images/4-Workshop/4.3-Tao-S3-Raw-Zone/image-001.png)

In the Amazon S3 console, select **Buckets**, then click **Create bucket** to start creating a new bucket.

![](/images/4-Workshop/4.3-Tao-S3-Raw-Zone/image-002.png)
...
![](/images/4-Workshop/4.3-Tao-S3-Raw-Zone/image-006.png)

Successfully created the folder **raw/**

![](/images/4-Workshop/4.3-Tao-S3-Raw-Zone/image-007.png)
...
![](/images/4-Workshop/4.3-Tao-S3-Raw-Zone/image-008.png)
...
![](/images/4-Workshop/4.3-Tao-S3-Raw-Zone/image-009.png)
...
![](/images/4-Workshop/4.3-Tao-S3-Raw-Zone/image-010.png)
