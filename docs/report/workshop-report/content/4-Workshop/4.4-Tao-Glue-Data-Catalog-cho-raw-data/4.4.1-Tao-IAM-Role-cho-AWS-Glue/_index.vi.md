---
title: "4.4.1. Tạo IAM Role cho AWS Glue"
linkTitle: "4.4.1. Tạo IAM Role cho AWS Glue"
menuTitle: "4.4.1. Tạo IAM Role cho AWS Glue"
date: 2026-05-29
weight: 441
chapter: false
---
...
![](/images/4-Workshop/4.4.1-Tao-IAM-Role-cho-AWS-Glue/image-001.png)

Trong menu bên trái, chọn **Roles** -> **Create role**.

![](/images/4-Workshop/4.4.1-Tao-IAM-Role-cho-AWS-Glue/image-002.png)
...
![](/images/4-Workshop/4.4.1-Tao-IAM-Role-cho-AWS-Glue/image-003.png)
...
![](/images/4-Workshop/4.4.1-Tao-IAM-Role-cho-AWS-Glue/image-004.png)
...
![](/images/4-Workshop/4.4.1-Tao-IAM-Role-cho-AWS-Glue/image-005.png)

Kiểm tra lại các thông tin đã cấu hình, sau đó nhấn **Create role**.

![](/images/4-Workshop/4.4.1-Tao-IAM-Role-cho-AWS-Glue/image-006.png)

IAM Role cho AWS Glue đã được tạo thành công.

![](/images/4-Workshop/4.4.1-Tao-IAM-Role-cho-AWS-Glue/image-007.png)
